...
class DSSL(nn.Module):
    ...
    def __init__(self, channels=80, kernel_size=3, stride=1, dilations=[2, 4, 8]):
...
class myModel(nn.Module):
    def __init__(self, num_classes):
        ...
        self.DSSL_module = DSSL(channels=96)
        self.DSSL_module_2 = DSSL(channels=96)
        self.DSSL_module_3 = DSSL(channels=96)
